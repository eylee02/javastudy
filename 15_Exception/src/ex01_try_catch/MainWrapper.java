...
public class MainWrapper {
  ...
  public static void ex01() {
    ...
    } catch(NumberFormatException e) {  // RuntimeException, Exception 가능 예외객체 이름 e
  ...
  public static void ex02() {
    ...
    } catch(ArrayIndexOutOfBoundsException e) {   // 사용할 수 있는 인덱스의 범위를 벗어났을때
      System.out.println("덧셈식에 +를 포함해서 입력하세요"); 
    } catch(Exception e) {  // NumberFormatException과 ArrayIndexOutOfBoundsException으로 처리못하는 예외를 담당한다.
