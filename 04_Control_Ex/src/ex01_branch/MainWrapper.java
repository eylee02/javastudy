...
public class MainWrapper {
  ...
  public static void ex05_2() {
    ...
    //월에 따른 계절    월 % 12  월을 12로 나눈 나머지로 범위지정
    //3 ~ 5 : 봄         3 ~ 5
    //6 ~ 8 : 여름       6 ~ 8
    //9 ~ 11: 가을       9 ~ 11
    //12 ~ 2: 겨울       0 ~ 2
  ...
  public static void ex07() {
    //10일 후 요일은?   요일찾기는 요일별 날짜들의 공통점 찾기 예시) 7의배수
    int day = 14;  // 14일은 금요일
    int nDay = 10;  // 10일
  ...
  public static void ex08() {
    // 대소문자 변환 (구글링으로 아스키코드 검색 후 참고)  +32   예시) 대문자 A는 65 소문자 a는 97)
    char ch = 'a';  // 임의의 대문자 또는 소문자    ch에 대문자가들어간다면 소문자로변환하기위해 +32 소문자가들어간다면 대문자로변환하기위해 -32
