...
public class MainWrapper1 {
  ...
  public static void ex03(double a, double b) {  // 인수가 실수 2개이면 파라미터 double a, double b 를 선언한다.
    System.out.println("ex03 : " + a);
    System.out.println("ex03 : " + b);
  }
  
  public static void ex04(String name, int age) {  // 문자열 인수는 파라미터 String, 정수 인수는 int로 선언한다.
