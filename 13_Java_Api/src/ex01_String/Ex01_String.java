...
public class Ex01_String {
  ...
  public static void ex07() {
    ...
    String firstName = name.substring(0, 3);  // tom 반환 인덱스 0번부터 3번까지(4글자)
    String lastName = name.substring(4);  // cruise 반환  인덱스 4번부터 끝까지
  ...
  public static void ex14() {
    ...
    // replace 메소드
    // 1. 지정된 문자열을 다른 문자열로 변환하는 역할을 수행한다.
    // 2. 발견된 모든 문자열을 변환한다.
