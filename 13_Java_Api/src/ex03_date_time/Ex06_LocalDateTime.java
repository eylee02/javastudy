...
public class Ex06_LocalDateTime {
  ...
  public static void ex03() {
    ...
    // 특정 날짜와 시간
    LocalDateTime dateTime2 = LocalDateTime.of(2023, 7, 31, 15, 28, 30);
    System.out.println(dateTime2);
    
    // 문자열 형식의 날짜와 시간
    LocalDateTime dateTime3 = LocalDateTime.parse("2023-07-31T15:30:30");
  ...
  public static void ex04() {
    ...
    String srtDateTime = dtf.format(dateTime);
    System.out.println(srtDateTime);
