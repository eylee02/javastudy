package ex03_opertator;

public class MainWrapper {

  // ex01 메소드 만들기(메소드 정의) -정수,실수연산
  public static void ex01() {
    // 정수 연산
    int a = 5;
    int b = 2;
    
    int add = a + b;  //a+b의 값을 add로 보냄(대입연산)
    int sub = a - b;
    int mul = a * b;
    int mok = a / b;  // 몫
    int mod = a % b;  // 나머지
    ...
    // 2.5가 나오는출력(정수끼리 계산해서 실수 결과 도출하기)
    int i = 5;
    int j = 2;
    
    double result = (double)i / j;  // i를 실수(double)로 캐스팅 , j는 자동으로 실수로바뀜
    System.out.println(result);        
    
  }

  // ex02 메소드 정의 -증감,전위,후위연산
  ...
  public static void ex04() {
    ...
    // 3. 논리 NOT : ! , 조건 결과가 true이면 false, 조건결과가 false이면 true
    int x = 10;
    int y = 20;
