...
public class MainWrapper {
  ...
  public static void ex01() {
     ...
     *    1) 프로토콜   : 통신규약, http(secure + http : 보안 처리 된 하이퍼텍스트 전송 프로토콜)
     *    2) 호스트     : 서버주소 
     *    3) URLMapping : 서버경로
     *    4) 파라미터   : 서버로 보내는 데이터
     */
  ...
  public static void ex02() {
    ...
    // 접속할 주소
    String spec = "https://ssl.pstatic.net/melona/libs/1456/1456783/0295cb7e25891ad30427_20230803154249971.jpg";
  ...
  public static void ex04() {
    ...
    try {
      ...
      // 원본 데이터
      String originData = "홍길동 tom 12345 !@#$%^&";
